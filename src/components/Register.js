...
function Register() {
	...
	return (
		<>
			...
			<Modal title='Register' visible={displayModal} onCancel={handleCancel} footer={null} destroyOnClose={true}>
				<Form name='normal_register' initialValues={{ remember: true }} onFinish={onFinish} preserve={false}>
